...
class ResNet101(Network):
    def setup(self):
        ...
        (self.feed('res4b9_relu',
             ...
             .batch_normalization(scale=True, center=True, name='bn4b11_branch2c'))

        (self.feed('res4b10_relu',
                   'bn4b11_branch2c')
             .add(name='res4b11')
             .relu(name='res4b11_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b12_branch2a')
...
class ResNet152(Network):
    def setup(self):
        ...
        (self.feed('res4b21_relu',
             ...
             .add(name='res4b22')
             .relu(name='res4b22_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b23_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b23_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b23_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b23_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b23_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b23_branch2c'))

        (self.feed('res4b22_relu',
                   'bn4b23_branch2c')
             .add(name='res4b23')
             .relu(name='res4b23_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b24_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b24_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b24_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b24_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b24_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b24_branch2c'))

        (self.feed('res4b23_relu',
                   'bn4b24_branch2c')
             .add(name='res4b24')
             .relu(name='res4b24_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b25_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b25_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b25_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b25_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b25_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b25_branch2c'))

        (self.feed('res4b24_relu',
                   'bn4b25_branch2c')
             .add(name='res4b25')
             .relu(name='res4b25_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b26_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b26_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b26_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b26_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b26_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b26_branch2c'))

        (self.feed('res4b25_relu',
                   'bn4b26_branch2c')
             .add(name='res4b26')
             .relu(name='res4b26_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b27_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b27_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b27_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b27_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b27_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b27_branch2c'))

        (self.feed('res4b26_relu',
                   'bn4b27_branch2c')
             .add(name='res4b27')
             .relu(name='res4b27_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b28_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b28_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b28_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b28_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b28_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b28_branch2c'))

        (self.feed('res4b27_relu',
                   'bn4b28_branch2c')
             .add(name='res4b28')
             .relu(name='res4b28_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b29_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b29_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b29_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b29_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b29_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b29_branch2c'))

        (self.feed('res4b28_relu',
                   'bn4b29_branch2c')
             .add(name='res4b29')
             .relu(name='res4b29_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b30_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b30_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b30_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b30_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b30_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b30_branch2c'))

        (self.feed('res4b29_relu',
                   'bn4b30_branch2c')
             .add(name='res4b30')
             .relu(name='res4b30_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b31_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b31_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b31_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b31_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b31_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b31_branch2c'))

        (self.feed('res4b30_relu',
                   'bn4b31_branch2c')
             .add(name='res4b31')
             .relu(name='res4b31_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b32_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b32_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b32_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b32_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b32_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b32_branch2c'))

        (self.feed('res4b31_relu',
                   'bn4b32_branch2c')
             .add(name='res4b32')
             .relu(name='res4b32_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b33_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b33_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b33_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b33_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b33_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b33_branch2c'))

        (self.feed('res4b32_relu',
                   'bn4b33_branch2c')
             .add(name='res4b33')
             .relu(name='res4b33_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b34_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b34_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b34_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b34_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b34_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b34_branch2c'))

        (self.feed('res4b33_relu',
                   'bn4b34_branch2c')
             .add(name='res4b34')
             .relu(name='res4b34_relu')
             .conv(1, 256, 1, biased=False, relu=False, name='res4b35_branch2a')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b35_branch2a')
             .conv(3, 256, 1, biased=False, relu=False, name='res4b35_branch2b')
             .batch_normalization(scale=True, center=True, relu=True, name='bn4b35_branch2b')
             .conv(1, 1024, 1, biased=False, relu=False, name='res4b35_branch2c')
             .batch_normalization(scale=True, center=True, name='bn4b35_branch2c'))
