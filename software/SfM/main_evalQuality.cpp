...
int main(int argc, char **argv)
{
  ...
  std::string
    ...
    sComputedDirectory,
    sOutDir = "";
  int camType = -1; //1: i23dSFM cam, 2,3: Strechas cam
  ...
  try {
    ...
    std::cerr << "Usage: " << argv[0] << '\n'
      ...
      << "[-c|--computed] path (i23dSFM SfM_Output directory)\n"
  ...
  {
    case 1:
      std::cout << "\nusing i23dSFM Camera";
      fcnReadCamPtr = &read_i23dSFM_Camera;
      suffix = "bin";
      break;
    case 2:
    case 3:
  ...
  // Evaluation
  htmlDocument::htmlDocumentStream _htmlDocStream("i23dSFM Quality evaluation.");
