...
#ifndef I23DSFM_SFM_IO_H
#define I23DSFM_SFM_IO_H
                           ...
                           bool bVerbose = true )
{
  ...
  std::vector<i23dSFM::SfMIO::CameraInfo> vec_camImageIntrinsicInfo;
  std::vector<i23dSFM::SfMIO::IntrinsicCameraInfo> vec_focalGroup;
  if (loadImageList( vec_camImageIntrinsicInfo,
                      vec_focalGroup,
                      sListFileName,
                      bVerbose) )
  {
    for ( std::vector<i23dSFM::SfMIO::CameraInfo>::const_iterator
