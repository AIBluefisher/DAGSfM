...
#include "i23dSFM/cameras/PinholeCamera.hpp"
...
static bool read_i23dSFM_Camera(const std::string & camName, PinholeCamera & cam)
{
...
@param[in] functorPointer, to the function which can handle the trajectory format. Example: &read_i23dSFM_Camera
@param[in] sGTPath, the directory where the camera files are located.
@param[in] Suffix: use "bin" for i23dSFM or "png.camera" for Strechas data.
