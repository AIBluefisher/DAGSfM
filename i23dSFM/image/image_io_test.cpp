...
TEST(GetFormat, filenames) {
  EXPECT_EQ(GetFormat("something.jpg"), i23dSFM::image::Jpg);
  EXPECT_EQ(GetFormat("something.png"), i23dSFM::image::Png);
  EXPECT_EQ(GetFormat("something.pnm"), i23dSFM::image::Pnm);
  EXPECT_EQ(GetFormat("something.tif"), i23dSFM::image::Tiff);
  EXPECT_EQ(GetFormat("/some/thing.JpG"), i23dSFM::image::Jpg);
  EXPECT_EQ(GetFormat("/some/thing.pNG"), i23dSFM::image::Png);
  EXPECT_EQ(GetFormat("some/thing.PNm"), i23dSFM::image::Pnm);
  EXPECT_EQ(GetFormat("some/thing.TIf"), i23dSFM::image::Tiff);
  EXPECT_EQ(GetFormat(".s/o.m/e.t/h.i/n.g.JPG"), i23dSFM::image::Jpg);
  EXPECT_EQ(GetFormat(".s/o.m/e.t/h.i/n.g.PNG"), i23dSFM::image::Png);
  EXPECT_EQ(GetFormat(".s/o.m/e.t/h.i/n.g.PNM"), i23dSFM::image::Pnm);
  EXPECT_EQ(GetFormat(".s/o.m/e.t/h.i/n.g.TIF"), i23dSFM::image::Tiff);
}
