...
#ifndef I23DSFM_IMAGE_IMAGE_CONVOLUTION_HPP_
#define I23DSFM_IMAGE_IMAGE_CONVOLUTION_HPP_

#include "i23dSFM/numeric/accumulator_trait.hpp"
                                ...
                                Image<float> & out)
{
  ...
  typedef Eigen::Matrix<typename i23dSFM::Accumulator<pix_t>::Type, Eigen::Dynamic, 1> VecKernel;
  const VecKernel horiz_k_cast = horiz_k.template cast< typename i23dSFM::Accumulator<pix_t>::Type >();
  const VecKernel vert_k_cast = vert_k.template cast< typename i23dSFM::Accumulator<pix_t>::Type >();
...
#endif // I23DSFM_IMAGE_IMAGE_CONVOLUTION_HPP_
