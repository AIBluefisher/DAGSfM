...
#ifndef I23DSFM_SFM_REPORT_HPP
#define I23DSFM_SFM_REPORT_HPP
...
static bool Generate_SfM_Report( const SfM_Data & sfm_data, const std::string & htmlFilename)
{
