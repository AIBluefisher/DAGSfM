...
#ifndef I23DSFM_SFM_FILTERS_HPP
#define I23DSFM_SFM_FILTERS_HPP
...
void KeepOnlyReferencedElement(
  const std::set<IndexT> & set_remainingIds,
  i23dSFM::matching::PairWiseMatches& map_matches)
{
  i23dSFM::matching::PairWiseMatches map_matches_E_infered;
  for (i23dSFM::matching::PairWiseMatches::const_iterator iter = map_matches.begin();
