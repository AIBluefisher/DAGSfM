...
IntegralImages::IntegralImages(const i23dSFM::image::Image< float >& I)
{
...
std::ofstream& writeDetector( std::ofstream& out, const i23dSFM::features::SIOPointFeature& feature )
{
  out << feature.x() << " "
    << feature.y() << " "
    << feature.scale() << " "
