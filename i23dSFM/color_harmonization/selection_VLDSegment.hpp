...
#ifndef I23DSFM_COLORHARMONIZATION_VLDSEGMENT_H
#define I23DSFM_COLORHARMONIZATION_VLDSEGMENT_H

#include "i23dSFM/color_harmonization/selection_interface.hpp"
#include "i23dSFM/matching/kvld/kvld.h"
#include "i23dSFM/matching/kvld/kvld_draw.h"
...
class commonDataByPair_VLDSegment  : public commonDataByPair
{
    ...
    image::Image< unsigned char > & maskRight )
  {
    ...
    i23dSFM::Mat E = i23dSFM::Mat::Ones( _vec_PutativeMatches.size(), _vec_PutativeMatches.size() ) * ( -1 );
...
#endif  // I23DSFM_COLORHARMONIZATION_VLDSEGMENT_H
