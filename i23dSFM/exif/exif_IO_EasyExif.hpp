...
#include "i23dSFM/exif/exif_IO.hpp"
...
class Exif_IO_EasyExif : public Exif_IO
{
  public:
    ...
    {
      return static_cast<float>(exifInfo_.GeoLocation.Latitude);
    }

    float getLongitude() const
    {
      return static_cast<float>(exifInfo_.GeoLocation.Longitude);
    }

    float getAltitude() const
    {
      return static_cast<float>(exifInfo_.GeoLocation.Altitude);
    }
